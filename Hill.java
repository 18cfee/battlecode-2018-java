...
public class Hill {
    ...
    public int getGradient(MapLoc loc){
        return hill[loc.x][loc.y];
    }
    public short getGradient(MapLocation loc){
        return hill[loc.getX()][loc.getY()];
    }
    public short getGradient(int x, int y){
        return hill[x][y];
    }
}
